  ...
  return (
    ...
    >
      <div className="grid grid-rows-[60px_1fr] border-r  border-gray-400 duration-500">
        <div
          className={cn(
            'grid border-b w-full border-gray-400 ',
            open ? 'grid-cols-[1fr_60px]' : 'grid-cols-1',
          )}
        >
          <div
            className={cn(
              'flex justify-center items-center whitespace-nowrap overflow-hidden',
              !open && 'hidden',
            )}
          >
            Top-nav Bar
          ...
          <div
            className={cn(
              'flex justify-center items-center cursor-pointer duration-700',
            )}
